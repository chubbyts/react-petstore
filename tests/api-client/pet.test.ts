import { ListPets, CreatePet, ReadPet, UpdatePet, DeletePet } from '../../src/api-client/pet';
import fetchMock from 'fetch-mock';
import { describe, test, expect, beforeEach } from 'vitest';
import { PetList, PetResponse } from '../../src/model/model';
import { BadRequest, InternalServerError, NetworkError, NotFound, UnprocessableEntity } from '../../src/api-client/error';
